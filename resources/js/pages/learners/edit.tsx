...
export default function EditLearner({ learner }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/learners/${learner.learner_id}/edit`,
        },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('learners.update', learner.learner_id));
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">✏️ Edit Learner</h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">
                        Update {learner.name}'s profile information
                    </p>
                </div>
